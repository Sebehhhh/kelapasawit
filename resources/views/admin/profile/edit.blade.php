        ...
        <div class="card shadow-lg border-0">
            <div class="card-body p-4">
                <div class="text-center mb-4">
                    <div class="mb-2">
                        <i class="ti ti-shield-check" style="font-size:3rem;color:#198754;"></i>
                    </div>
                    <h4 class="fw-bold mb-1">Profil Admin</h4>
                    <div class="text-muted">Perbarui data profil dan password akun admin Anda.</div>
                </div>
                <hr>
                @if(session('success'))
                ...
                <form method="POST" action="{{ route('admin.profile.update') }}">
                    ...
                    <div class="d-grid gap-2 mt-4">
                        <button type="submit" class="btn btn-success btn-lg shadow">Simpan Perubahan</button>
                    </div>
                </form>
            </div>
        </div>
