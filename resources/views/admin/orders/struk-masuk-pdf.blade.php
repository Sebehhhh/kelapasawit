...
<html>
<head>
    <title>Laporan Struk Masuk</title>
    <style>
...
<body>
    <div class="header">
        ...
        <h2>LAPORAN STRUK MASUK</h2>
        <p>Tanggal Cetak: {{ date('d/m/Y H:i:s') }}</p>
        <p><em>Struk masuk dari pembelian barang</em></p>
    </div>
    <table>
        <thead>
            <tr>
        ...
        <tbody>
            ...
            @forelse($invoices as $inv)
                @foreach($inv->details as $detail)
                    ...
                    <tr>
                        ...
                        <td class="text-center">{{ $detail->quantity }} unit</td>
            ...
            @empty
                <tr>
                    <td colspan="8" class="text-center">Tidak ada data struk masuk</td>
                </tr>
            @endforelse
        </tbody>
    </table>
    ...
    <div class="summary">
        <table style="width: 50%; margin-left: auto;">
            <tr>
                <td><strong>Total Transaksi Masuk:</strong></td>
                <td class="text-right"><strong>{{ $invoices->count() }} transaksi</strong></td>
            </tr>
            <tr>
                <td><strong>Total Item Masuk:</strong></td>
                <td class="text-right"><strong>{{ $totalQty }} unit</strong></td>
            </tr>
            <tr>
                <td><strong>Total Nilai Masuk:</strong></td>
